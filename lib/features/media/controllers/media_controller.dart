...
class MediaController extends GetxController {
  ...
  final Rx<MediaCategory> selectedPath = MediaCategory.carpetas.obs;
  ...
  void getMediaImages() async {
    try {
      ...
      } else if (selectedPath.value == MediaCategory.marcas && allBrandImages.isEmpty) {
        targetList = allBrandImages;
      } else if (selectedPath.value == MediaCategory.categorias && allCategoryImages.isEmpty) {
        targetList = allCategoryImages;
      } else if (selectedPath.value == MediaCategory.productos && allProductImages.isEmpty) {
        targetList = allProductImages;
      } else if (selectedPath.value == MediaCategory.usuarios && allUserImages.isEmpty) {
  ...
  loadMoreMediaImages() async {
    try {
      ...
      if (selectedPath.value == MediaCategory.banners) {
        targetList = allBannerImages;
      } else if (selectedPath.value == MediaCategory.marcas) {
        targetList = allBrandImages;
      } else if (selectedPath.value == MediaCategory.categorias) {
        targetList = allCategoryImages;
      } else if (selectedPath.value == MediaCategory.productos) {
        targetList = allProductImages;
      } else if (selectedPath.value == MediaCategory.usuarios) {
        targetList = allUserImages;
      }
  ...
  void uploadImagesConfirmation() {
    if (selectedPath.value == MediaCategory.carpetas) {
    ...
    try {
      ...
      switch (selectedCategory) {
        case MediaCategory.banners:
          targetList = allBannerImages;
          break;
        case MediaCategory.marcas:
          targetList = allBrandImages;
          break;
        case MediaCategory.categorias:
          targetList = allCategoryImages;
          break;
