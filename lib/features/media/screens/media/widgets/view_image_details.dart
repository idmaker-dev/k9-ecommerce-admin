        ...
        child: TRoundedContainer(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Expanded(child: Text('Nombre de la imagen:', style: Theme.of(context).textTheme.bodyLarge)),
              ...
              Row(
                children: [
                  Expanded(child: Text('URL de la imagen:', style: Theme.of(context).textTheme.bodyLarge)),
                  Expanded(
                    flex: 2,
