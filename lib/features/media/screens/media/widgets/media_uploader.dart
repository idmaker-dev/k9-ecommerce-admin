                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                const Text('Arrastra y suelta imágenes aquí'),
                                const SizedBox(height: TSizes.spaceBtwItems),
                                OutlinedButton(onPressed: () => controller.selectLocalImages(), child: const Text('Selecciona imagenes')),
                              ],
                            ),
                          ],
                        ),
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            Row(
                              children: [
                                Text('Seleccionar carpera', style: Theme.of(context).textTheme.headlineSmall),
                            ...
                            Row(
                              children: [
                                TextButton(onPressed: () => controller.selectedImagesToUpload.clear(), child: const Text('Quitar todas')),
                                const SizedBox(width: TSizes.spaceBtwItems),
