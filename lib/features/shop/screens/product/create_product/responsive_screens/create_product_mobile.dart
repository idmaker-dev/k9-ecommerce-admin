          ...
          child: Column(
            ...
            children: [
              ...
              const TBreadcrumbsWithHeading(
                  returnToPreviousScreen: true, heading: 'Crear Producto', breadcrumbItems: [TRoutes.products, 'Crear Producto']),
                ...
                children: [
                  ...
                  TRoundedContainer(
                    child: Column(
                      ...
                      children: [
                        // Heading
                        Text('Existencia y Precio', style: Theme.of(context).textTheme.headlineSmall),
                  ...
                  TRoundedContainer(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Imagenes del producto', style: Theme.of(context).textTheme.headlineSmall),
                        const SizedBox(height: TSizes.spaceBtwItems),
