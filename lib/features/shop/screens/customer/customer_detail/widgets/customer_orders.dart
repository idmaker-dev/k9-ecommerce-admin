      ...
      child: Obx(
        () {
          ...
          if (controller.allCustomerOrders.isEmpty) {
            return const TAnimationLoaderWidget(text: 'No se encontraron pedidos', animation: TImages.tableIllustration);
          }
          ...
          return Column(
            ...
            children: [
                  ...
                  Text.rich(
                    TextSpan(
                      children: [
                        ...
                        TextSpan(text: ' en ${controller.allCustomerOrders.length} Pedidos', style: Theme.of(context).textTheme.bodyLarge),
                      ],
                    ),
                  ),
                ],
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(hintText: 'Buscar pedidos', prefixIcon: Icon(Iconsax.search_normal)),
              ),
